...
def parallel_compute(edge_weight, paper_year, src, dst, num_workers=48):
...
def prepare_label_emb(args, g, labels, n_classes, train_idx, valid_idx, test_idx, paper_year, label_teacher_emb=None):
    ...
    if not os.path.isfile("./dgl_heize_edge_weight.pt"):
        ...
        torch.save(edge_weight,"./dgl_heize_edge_weight.pt")
    else:
        edge_weight=torch.load("./dgl_heize_edge_weight.pt")
