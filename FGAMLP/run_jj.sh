...
output_emb_prefix=./ogbn-papers100M-jj.node-emb
input_emb_path=None
gpu=0
...
if [ ! -f "${output_emb_prefix}_${num_hops}.pt" ]; then
    python -u ./data/preprocess_pmp_papers100m.py \
        ...
        |& tee ./gamlp.ogbn-papers100M.prepare-JJ.log
fi
python -u main_pmp.py \
    ...
    --use-rlu \
    --method R_GAMLP_RLU \
    --stages 50 50 50 50 50 50 50 50 50 50\
    ...
    --bns \
    --temp 0.001 \
    |& tee ./gamlp.ogbn-papers100M.JJ-real.log