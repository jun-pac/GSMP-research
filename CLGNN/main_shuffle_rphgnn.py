...
print(f"train_index : {type(train_index)} {train_index.shape}")
print(f"train_min max : {np.min(train_index)} {np.max(train_index)}")
print(f"valid_index : {type(valid_index)} {valid_index.shape}")
print(f"valid_min max : {np.min(valid_index)} {np.max(valid_index)}")
print(f"test_index : {type(test_index)} {test_index.shape}")
print(f"test_min max : {np.min(test_index)} {np.max(test_index)}")
