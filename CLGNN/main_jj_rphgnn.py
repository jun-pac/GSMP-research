...
from rphgnn.layers.rphgnn_jj_pre import rphgnn_propagate_and_collect, rphgnn_propagate_and_collect_label
# import umap
...
def create_label_target_h_list_list():
    ...
    label_target_h_list_list = rphgnn_propagate_and_collect_label(hetero_graph, target_node_type, y, train_label_feat, paper_year)
