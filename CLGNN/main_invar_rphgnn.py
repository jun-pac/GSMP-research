...
print(f"validation_freq : {validation_freq}")
...
print(f"Debug0328 : type(feat_target_h_list_list) {type(feat_target_h_list_list)}") # list
print(f"Debug0328 : type(feat_target_h_list_list[0]) {type(feat_target_h_list_list[0])}") # numpy.ndarray
print(f"Debug0328 : len(feat_target_h_list_list) {len(feat_target_h_list_list)}") # len(feat_target_h_list_list) 6
print(f"Debug0328 : torch_y.shape {torch_y.shape}") # torch_y.shape torch.Size([736389])
print(f"Debug0328 : type(torch_y) {type(torch_y)}") # type(torch_y) <class 'torch.Tensor'>
print(f"Debug0328 : type(y[0]) {type(y[0])}") # <class 'numpy.int64'>
paper_year=torch.squeeze(paper_year)
print(f"Debug0328 : paper_year.shape {paper_year.shape}") # paper_year.shape torch.Size([736389])
print(f"Debug0328 : type(paper_year) {type(paper_year)}") # type(paper_year) <class 'torch.Tensor'>
print(f"Debug0328 : paper_year[0] {paper_year[0]}") # paper_year[0] 2015
...
print(f"Debug0328 : type(feat_target_h_list_list) {type(feat_target_h_list_list)}") # 
print(f"Debug0328 : feat_target_h_list_list[0].shape {feat_target_h_list_list[0].shape}") # 
print(f"Debug0328 : feat_target_h_list_list[1].shape {feat_target_h_list_list[1].shape}") # 
print(f"Debug0328 : feat_target_h_list_list[2].shape {feat_target_h_list_list[2].shape}") # 
print(f"Debug0328 : feat_target_h_list_list[3].shape {feat_target_h_list_list[3].shape}") # 
print(f"Debug0328 : feat_target_h_list_list[4].shape {feat_target_h_list_list[4].shape}") # 
print(f"Debug0328 : feat_target_h_list_list[5].shape {feat_target_h_list_list[5].shape}") # 
'''
type(feat_target_h_list_list) <class 'list'>
Debug0328 : feat_target_h_list_list[0].shape torch.Size([736389, 3, 512])
Debug0328 : feat_target_h_list_list[1].shape torch.Size([736389, 4, 128])
Debug0328 : feat_target_h_list_list[2].shape torch.Size([736389, 3, 128])
Debug0328 : feat_target_h_list_list[3].shape torch.Size([736389, 4, 128])
Debug0328 : feat_target_h_list_list[4].shape torch.Size([736389, 3, 512])
Debug0328 : feat_target_h_list_list[5].shape torch.Size([736389, 4, 128])
