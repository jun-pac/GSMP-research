...
def main(args):
    ...
    for task in range(len(train_loaders)):
        ...
        if args.joint:
            done_list=[1,2,3,4,5,6,7,8]
        print(f"Train_list : {done_list}")
        
        if task+1 in done_list:
...
# conda activate vv
# python cifar100_KNN_exponential_joint.py |&tee out_w_pretrained.txt
# python cifar100_KNN_exponential_joint.py |&tee out_wo_pretrained.txt

# python cifar100_KNN_exponential_joint.py --joint --epoch 30 |&tee output/supervised_joint.txt
# python cifar100_KNN_exponential_joint.py --epoch 20 |&tee output/supervised_20.txt
# python cifar100_KNN_exponential_joint.py --epoch 10 |&tee output/supervised_10.txt
# python cifar100_KNN_exponential_joint.py --epoch 5 |&tee output/supervised_5.txt

# python cifar100_KNN_exponential_joint.py --epoch 15 |&tee output/supervised_15.txt
# python cifar100_KNN_exponential_joint.py --epoch 25 |&tee output/supervised_25.txt