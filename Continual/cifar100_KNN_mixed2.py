...
from SimCLR.models.resnet_simclr_mixed2 import ResNetSimCLR
from SimCLR.simclr_mixed2 import SimCLR
...
# Experimented
# python cifar100_KNN_mixed2.py --loss-ratio 1 --pretrained --epochs 50 --annoy 1000 --batch-size 500 --in-size 32 --distance angular |&tee output/mixed2_1_32_w_50_a1000.txt
# python cifar100_KNN_mixed2.py --loss-ratio 2 --pretrained --epochs 50 --annoy 1000 --batch-size 500 --in-size 32 --distance angular |&tee output/mixed2_2_32_w_50_a1000.txt
# python cifar100_KNN_mixed2.py --loss-ratio 0.5 --pretrained --epochs 50 --annoy 1000 --batch-size 500 --in-size 32 --distance angular |&tee output/mixed2_0.5_32_w_50_a1000.txt
# python cifar100_KNN_mixed2.py --loss-ratio 0.2 --pretrained --epochs 50 --annoy 1000 --batch-size 500 --in-size 32 --distance angular |&tee output/mixed2_0.2_32_w_50_a1000.txt


# python cifar100_KNN_mixed2.py --loss-ratio 10 --pretrained --epochs 50 --annoy 1000 --batch-size 500 --in-size 32 --distance angular |&tee output/mixed2_10_32_w_50_a1000.txt
