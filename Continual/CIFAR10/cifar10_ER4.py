...
def main(args):
    ...
    GEM = GEMPlugin(patterns_per_experience=1000, memory_strength=0.5)
...
# python cifar10_ER4.py | tee log/ER4

# ewc + replay(1000) : Top1_Acc_Stream/eval_phase/test_stream/Task000 = 0.2086, 0.2501
