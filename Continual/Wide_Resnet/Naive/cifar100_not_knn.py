...
def main(args):
    ...
    cl_strategy = Naive( 
        ...
        eval_mb_size=50,
        device=device,
        plugins=[ReplayPlugin(mem_size=50000,batch_size=5)], # To fit all data
...
# conda activate vv
# cd Persistent_Message_Passing/Continual/Wide_Resnet/Naive/
# python cifar100_not_knn.py | tee log/output_5
# python cifar100_not_knn.py | tee log/output_10
# python cifar100_not_knn.py | tee log/output_100
