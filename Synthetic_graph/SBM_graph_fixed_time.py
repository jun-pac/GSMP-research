...
sample_func['binary1']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['binary2']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['binary3']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['binary4']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['binary5']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['binary6']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['binary7']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]

sample_func['bi1']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['bi2']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['bi3']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['bi4']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['bi5']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['bi6']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['bi7']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['bi8']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
sample_func['bi9']=lambda cur_label:torch.randn(args.feat_dim)*32+feat_center[cur_label]
...
matrix_func['binary1']=lambda delta_t,label_i,label_j:(0.01+0.01*label_i if label_i==label_j else 0.028*(num_time-delta_t)/num_time)
matrix_func['binary2']=lambda delta_t,label_i,label_j:(0.01+0.01*label_i if label_i==label_j else 0.026*(num_time-delta_t)/num_time)
matrix_func['binary3']=lambda delta_t,label_i,label_j:(0.01+0.01*label_i if label_i==label_j else 0.024*(num_time-delta_t)/num_time)
matrix_func['binary4']=lambda delta_t,label_i,label_j:(0.01+0.01*label_i if label_i==label_j else 0.02*(num_time-delta_t)/num_time)
matrix_func['binary5']=lambda delta_t,label_i,label_j:(0.01+0.01*label_i if label_i==label_j else 0.018*(num_time-delta_t)/num_time)
matrix_func['binary6']=lambda delta_t,label_i,label_j:(0.01+0.01*label_i if label_i==label_j else 0.016*(num_time-delta_t)/num_time)
matrix_func['binary7']=lambda delta_t,label_i,label_j:(0.01+0.01*label_i if label_i==label_j else 0.012*(num_time-delta_t)/num_time)

matrix_func['bi1']=lambda delta_t,label_i,label_j:(0.02 if label_i==label_j else 0.010667+0.000*(num_time-delta_t)/num_time)
matrix_func['bi2']=lambda delta_t,label_i,label_j:(0.02 if label_i==label_j else 0.009333+0.002*(num_time-delta_t)/num_time)
matrix_func['bi3']=lambda delta_t,label_i,label_j:(0.02 if label_i==label_j else 0.008000+0.004*(num_time-delta_t)/num_time)
matrix_func['bi4']=lambda delta_t,label_i,label_j:(0.02 if label_i==label_j else 0.006667+0.006*(num_time-delta_t)/num_time)
matrix_func['bi5']=lambda delta_t,label_i,label_j:(0.02 if label_i==label_j else 0.005333+0.008*(num_time-delta_t)/num_time)
matrix_func['bi6']=lambda delta_t,label_i,label_j:(0.02 if label_i==label_j else 0.004000+0.010*(num_time-delta_t)/num_time)
matrix_func['bi7']=lambda delta_t,label_i,label_j:(0.02 if label_i==label_j else 0.002667+0.012*(num_time-delta_t)/num_time)
matrix_func['bi8']=lambda delta_t,label_i,label_j:(0.02 if label_i==label_j else 0.001333+0.014*(num_time-delta_t)/num_time)
matrix_func['bi9']=lambda delta_t,label_i,label_j:(0.02 if label_i==label_j else 0.016*(num_time-delta_t)/num_time)
