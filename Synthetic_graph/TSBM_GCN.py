...
if __name__ == "__main__":
    ...
    # f_log_base.write('GCN_'+'L'+str(args.L)+'_'+'d'+str(args.decay)+'_'+str(args.K)+'_'+str(args.G)+'_b'+'\n')
    # f_log_base.flush()
    # f_log_MMP.write('GCN_'+'L'+str(args.L)+'_'+'d'+str(args.decay)+'_'+str(args.K)+'_'+str(args.G)+'_mmp'+'\n')
    # f_log_MMP.flush()
    # f_log_PMP.write('GCN_'+'L'+str(args.L)+'_'+'d'+str(args.decay)+'_'+str(args.K)+'_'+str(args.G)+'_pmp'+'\n')
    # f_log_PMP.flush()
    # f_log_JJ.write('GCN_'+'L'+str(args.L)+'_'+'d'+str(args.decay)+'_'+str(args.K)+'_'+str(args.G)+'_jj'+'\n')
    # f_log_JJ.flush()
    # f_log_PNY.write('GCN_'+'L'+str(args.L)+'_'+'d'+str(args.decay)+'_'+str(args.K)+'_'+str(args.G)+'_pny'+'\n')
    # f_log_PNY.flush()    
...
# 0517
while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.3 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.4 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.5 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.6 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.7 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.8 --epoch 200; done


while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.35 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.45 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.55 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.65 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.75 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.85 --epoch 200; done


# while sleep 1; do python TSBM_GCN.py --L -1 --decay 0.8 --epoch 200; done # tot node = 2000
# while sleep 1; do python TSBM_GCN.py --L 0 --decay 0.8 --epoch 200; done # tot node=1000
# node = 2000
while sleep 1; do python TSBM_GCN.py --L 3 --decay 0.8 --epoch 200; done [0.4 0.6]
while sleep 1; do python TSBM_GCN.py --L 3 --decay 0.7 --epoch 200; done [0.4 0.6] # Same thing
while sleep 1; do python TSBM_GCN.py --L 4 --decay 0.8 --epoch 200; done [0.4 0.7] 
while sleep 1; do python TSBM_GCN.py --L 4 --decay 0.7 --epoch 200; done [0.4 0.7] # Same thing

# I think node = 2000 is correct.

# time
while sleep 1; do python TSBM_GCN.py --L 5 --decay 0.9 --epoch 200; done 

while sleep 1; do python TSBM_GCN.py --L 4 --decay 0.8 --epoch 200; done
