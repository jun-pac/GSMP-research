...
if __name__ == "__main__":
    ...
    f_log=open('./txtlog/'+'b'+str(args.max_beta)+'_'+'g'+str(args.gamma)+'_'+'s'+str(args.feat_std)+'_Invar.txt','a')
    ...
    for i in range(args.repeat):
        for num in range(9):
            ...
            train_2(sym_g, f_log, alpha, beta, times)
            train_0(new_g, f_log, alpha, beta)
            train_1(sym_g, f_log, alpha, beta)
            print('',flush=True)
        print('',flush=True)
        # f_log0.write("\n")
        # f_log0.flush()
...
'''
# 0403
python TSBM_PMP.py --gamma 0.05 --max_beta 0.02 --epoch 150
python TSBM_PMP.py --gamma 0.12 --max_beta 0.06 --epoch 150
python TSBM_PMP.py --gamma 0.12 --max_beta 0.08 --epoch 150
python TSBM_PMP.py --gamma 0.16 --max_beta 0.06 --epoch 150 
python TSBM_PMP.py --gamma 0.16 --max_beta 0.10 --epoch 150
python TSBM_PMP.py --gamma 0.32 --max_beta 0.12 --epoch 150
python TSBM_PMP.py --gamma 0.32 --max_beta 0.16 --epoch 150
python TSBM_PMP.py --gamma 0.4 --max_beta 0.2 --epoch 150

# 0404
python TSBM_PMP.py --gamma 0.05 --max_beta 0.02 --epoch 400
python TSBM_PMP.py --gamma 0.12 --max_beta 0.06 --epoch 400
python TSBM_PMP.py --gamma 0.12 --max_beta 0.08 --epoch 400
python TSBM_PMP.py --gamma 0.16 --max_beta 0.06 --epoch 400 
python TSBM_PMP.py --gamma 0.16 --max_beta 0.10 --epoch 400
python TSBM_PMP.py --gamma 0.32 --max_beta 0.12 --epoch 400
python TSBM_PMP.py --gamma 0.32 --max_beta 0.16 --epoch 400
python TSBM_PMP.py --gamma 0.4 --max_beta 0.2 --epoch 400

python TSBM_PMP.py --gamma 0.18 --max_beta 0.12 --epoch 150
