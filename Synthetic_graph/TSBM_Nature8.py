...
if __name__ == "__main__":
    ...
    f_log0=open('./txtlog/'+'NH_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_0','a')
    f_log1=open('./txtlog/'+'NH_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_1','a')
    f_log2=open('./txtlog/'+'NH_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_2','a')
    f_logm=open('./txtlog/'+'NH_matrix_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay),'a')

    f_log0.write('NH_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_0\n')
    f_log0.flush()
    f_log1.write('NH_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_1\n')
    f_log1.flush()
    f_log2.write('NH_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_2\n')
    f_log2.flush()
...
python TSBM_Nature8.py --K 0.3 --G 0.4 --epoch 500
python TSBM_Nature8.py --K 0.3 --G 0.41 --labels 70 70 70 70 70 130 130 130 130 130 --epoch 300
python TSBM_Nature8.py --K 0.3 --G 0.42 --labels 40 40 40 40 40 160 160 160 160 160 --epoch 300
python TSBM_Nature8.py --K 0.5 --G 0.4 --epoch 500
python TSBM_Nature8.py --K 0.5 --G 0.41 --labels 70 70 70 70 70 130 130 130 130 130 --epoch 300
python TSBM_Nature8.py --K 0.5 --G 0.42 --labels 40 40 40 40 40 160 160 160 160 160 --epoch 300

python TSBM_Nature8.py --K 0.1 --G 0.41 --labels 70 70 70 70 70 130 130 130 130 130 --epoch 300
python TSBM_Nature8.py --K 0.1 --G 0.42 --labels 40 40 40 40 40 160 160 160 160 160 --epoch 300
python TSBM_Nature8.py --K 0.2 --G 0.41 --labels 70 70 70 70 70 130 130 130 130 130 --epoch 300
python TSBM_Nature8.py --K 0.2 --G 0.42 --labels 40 40 40 40 40 160 160 160 160 160 --epoch 300
python TSBM_Nature8.py --K 0.2 --G 0.41 --labels 70 70 70 70 70 130 130 130 130 130 --epoch 300
python TSBM_Nature8.py --K 0.2 --G 0.42 --labels 40 40 40 40 40 160 160 160 160 160 --epoch 300
python TSBM_Nature8.py --K 0.2 --G 0.41 --labels 70 70 70 70 70 130 130 130 130 130 --epoch 300
python TSBM_Nature8.py --K 0.2 --G 0.42 --labels 40 40 40 40 40 160 160 160 160 160 --epoch 300
