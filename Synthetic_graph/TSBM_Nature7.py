...
if __name__ == "__main__":
    ...
    parser.add_argument("--labels", nargs='+',type=int, default=[0])
    # torch.autograd.set_detect_anomaly(True)
    
    args = parser.parse_args()
    f_log0=open('./txtlog/'+'NG_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_0','a')
    f_log1=open('./txtlog/'+'NG_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_1','a')
    f_log2=open('./txtlog/'+'NG_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_2','a')
    # f_logm=open('./txtlog/'+'NG_matrix_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay),'a')

    f_log0.write('NG_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_0\n')
    f_log0.flush()
    f_log1.write('NG_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_1\n')
    f_log1.flush()
    f_log2.write('NG_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_2\n')
    f_log2.flush()
    
    flag=0
    for i in range(args.repeat):
        for num in range(10):
            label=torch.randint(0,args.num_label,(args.num_node,))
            ...
            if(args.labels[0]!=0):
                cnt=0
                for k in range(args.num_label):
                    for ii in range(args.labels[k]):
                        label[cnt]=k
                        cnt+=1
            ...
            for t in range(1,args.num_time):
                for y1 in range(args.num_label):
                    for y2 in range(args.num_label):
                        prob[y1][y2][t]=prob[y1][y2][t-1]*decay
            ...
            if(args.decay!=0 and (acc0<=0.1 or acc0>=acc1)):
                continue
            acc2=train_2(sym_g, f_log2, times)

            
            if(args.decay!=0 and acc0<acc1 and acc1<acc2):
                flag=1
                # f_logm.write(f"Good Graph args.K : {args.K}, args.G : {args.G}, decay : {decay}\n")
                # f_logm.flush()
                # for y1 in range(args.num_label):
                #     for y2 in range(args.num_label):
                ...
                print(f"Good graph iteration | args.K : {args.K}, args.G : {args.G}, decay : {decay}")
                f_log0.write("======\n")
                f_log0.flush()
                f_log1.write("======\n")
                f_log1.flush()
...
# 0429
conda activate vv
python TSBM_Nature7.py --K 0.3 --G 0.4 --epoch 300
python TSBM_Nature7.py --K 0.3 --G 0.6 --epoch 300

python TSBM_Nature7.py --K 0.1 --G 0.41 --labels 70 70 70 70 70 130 130 130 130 130 --epoch 300
python TSBM_Nature7.py --K 0.1 --G 0.42 --labels 40 40 40 40 40 160 160 160 160 160 --epoch 300
python TSBM_Nature7.py --K 0.2 --G 0.41 --labels 70 70 70 70 70 130 130 130 130 130 --epoch 300
python TSBM_Nature7.py --K 0.2 --G 0.42 --labels 40 40 40 40 40 160 160 160 160 160 --epoch 300
python TSBM_Nature7.py --K 0.3 --G 0.41 --labels 70 70 70 70 70 130 130 130 130 130 --epoch 300
python TSBM_Nature7.py --K 0.3 --G 0.42 --labels 40 40 40 40 40 160 160 160 160 160 --epoch 300
python TSBM_Nature7.py --K 0.5 --G 0.41 --labels 70 70 70 70 70 130 130 130 130 130 --epoch 300
python TSBM_Nature7.py --K 0.5 --G 0.42 --labels 40 40 40 40 40 160 160 160 160 160 --epoch 300



python TSBM_Nature7.py --K 0.5 --G 0.4 --labels 40 40 40 40 40 160 160 160 160 160 --epoch 300
python TSBM_Nature7.py --K 0.5 --G 0.39 --labels 30 30 30 30 30 170 170 170 170 170 --epoch 300
python TSBM_Nature7.py --K 0.5 --G 0.38 --labels 40 40 40 40 40 40 40 240 240 240 --epoch 300
python TSBM_Nature7.py --K 0.5 --G 0.37 --labels 40 40 40 40 40 40 40 40 40 640 --epoch 300
python TSBM_Nature7.py --K 0.5 --G 0.36 --labels 10 10 20 20 20 40 80 160 320 320 --epoch 300
python TSBM_Nature7.py --K 0.5 --G 0.35 --labels 10 30 50 70 90 110 130 150 170 190 --epoch 300
python TSBM_Nature7.py --K 0.5 --G 0.401 --labels 100 100 100 100 100 100 100 100 100 100 --epoch 300


conda activate vv

python TSBM_Nature7.py --K 0.6 --G 0.36 --labels 10 10 20 20 20 40 80 160 320 320 --epoch 200
python TSBM_Nature7.py --K 0.6 --G 0.37 --labels 40 40 40 40 40 40 40 40 40 640 --epoch 200
python TSBM_Nature7.py --K 0.6 --G 0.38 --labels 40 40 40 40 40 40 40 240 240 240 --epoch 200
python TSBM_Nature7.py --K 0.6 --G 0.39 --labels 30 30 30 30 30 170 170 170 170 170 --epoch 200
python TSBM_Nature7.py --K 0.6 --G 0.4 --labels 40 40 40 40 40 160 160 160 160 160 --epoch 200
python TSBM_Nature7.py --K 0.6 --G 0.41 --labels 60 60 60 60 60 140 140 140 140 140 --epoch 200
