...
if __name__ == "__main__":
    ...
    f_log0=open('./txtlog/'+'NB_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_0','a')
    f_log1=open('./txtlog/'+'NB_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_1','a')
    # f_log2=open('./txtlog/'+'NB_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_2','a')
    f_logm=open('./txtlog/'+'NB_matrix_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std),'a')

    f_log0.write('NB_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_0\n')
    f_log0.flush()
    f_log1.write('NB_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_1\n')
    f_log1.flush()
    # f_log2.write('NB_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_2\n')
    # f_log2.flush()
    ...
    for i in range(args.repeat):
        ...
        for y in range(args.num_label):
            for t in range(args.num_time):
                prob[y][y][t]=random.uniform(0, args.K)
        for y1 in range(args.num_label):
            for y2 in range(y1):
                mx=min(prob[y1][y1][0],prob[y2][y2][0])*args.G
                for t in range(args.num_time):
                    prob[y1][y2][t]=random.uniform(0,mx)
...
# 0426
conda activate vv
python TSBM_Nature2.py --K 0.4 --G 0.8 --epoch 600
python TSBM_Nature2.py --K 0.4 --G 0.6 --epoch 600
python TSBM_Nature2.py --K 0.4 --G 0.4 --epoch 600
python TSBM_Nature2.py --K 0.4 --G 0.3 --epoch 600
python TSBM_Nature2.py --K 0.2 --G 0.8 --epoch 600
python TSBM_Nature2.py --K 0.2 --G 0.6 --epoch 600
python TSBM_Nature2.py --K 0.2 --G 0.4 --epoch 600
python TSBM_Nature2.py --K 0.2 --G 0.3 --epoch 600
'''