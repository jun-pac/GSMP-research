...
if __name__ == "__main__":
    ...
    f_log0=open('./txtlog/'+'ND_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_0','a')
    f_log1=open('./txtlog/'+'ND_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_1','a')
    f_log2=open('./txtlog/'+'ND_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_2','a')
    f_logm=open('./txtlog/'+'ND_matrix_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay),'a')

    f_log0.write('ND_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_0\n')
    f_log0.flush()
    f_log1.write('ND_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_1\n')
    f_log1.flush()
    f_log2.write('ND_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_2\n')
    f_log2.flush()
...
# 0426
conda activate vv
python TSBM_Nature4.py --K 0.4 --G 0.8 --epoch 600
python TSBM_Nature4.py --K 0.4 --G 0.6 --epoch 600
python TSBM_Nature4.py --K 0.4 --G 0.4 --epoch 600
python TSBM_Nature4.py --K 0.4 --G 0.3 --epoch 600
python TSBM_Nature4.py --K 0.2 --G 0.8 --epoch 600
python TSBM_Nature4.py --K 0.2 --G 0.6 --epoch 600
python TSBM_Nature4.py --K 0.2 --G 0.4 --epoch 600
python TSBM_Nature4.py --K 0.2 --G 0.3 --epoch 600


python TSBM_Nature4.py --K 0.4 --G 0.3 --decay 0.7 --epoch 600
python TSBM_Nature4.py --K 0.2 --G 0.8 --decay 0.73 --epoch 600
python TSBM_Nature4.py --K 0.2 --G 0.8 --decay 0.73 --epoch 600
python TSBM_Nature4.py --K 0.4 --G 0.3 --decay 0.71 --epoch 600
python TSBM_Nature4.py --K 0.4 --G 0.4 --decay 0.9 --epoch 600
python TSBM_Nature4.py --K 0.4 --G 0.4 --decay 0.91 --epoch 600
python TSBM_Nature4.py --K 0.4 --G 0.8 --decay 0.7 --epoch 600


python TSBM_Nature4.py --K 0.3 --G 0.2 --epoch 600
python TSBM_Nature4.py --K 0.3 --G 0.4 --epoch 600
python TSBM_Nature4.py --K 0.3 --G 0.6 --epoch 600
python TSBM_Nature4.py --K 0.5 --G 0.2 --epoch 200
python TSBM_Nature4.py --K 0.5 --G 0.4 --epoch 600
python TSBM_Nature4.py --K 0.5 --G 0.6 --epoch 600
