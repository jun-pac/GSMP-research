...
if __name__ == "__main__":
    ...
    f_log0=open('./txtlog/'+'NF_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_0','a')
    f_log1=open('./txtlog/'+'NF_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_1','a')
    f_log2=open('./txtlog/'+'NF_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_2','a')
    f_logm=open('./txtlog/'+'NF_matrix_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay),'a')

    f_log0.write('NF_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_0\n')
    f_log0.flush()
    f_log1.write('NF_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_1\n')
    f_log1.flush()
    f_log2.write('NF_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'d'+str(args.decay)+'_2\n')
    f_log2.flush()
    ...
    for i in range(args.repeat):
        for num in range(6):
            ...
            for y1 in range(args.num_label):
                for y2 in range(y1):
                    mx=np.sqrt(prob[y1][y1][0]*prob[y2][y2][0])*args.G
                    # print(f"y1 y2 {y1} {y2} {prob[y1][y1][0]} {prob[y2][y2][0]} {np.sqrt(prob[y1][y1][0]*prob[y2][y2][0])} {mx}")
                    prob[y1][y2][0]=random.uniform(0,mx)
            ...
            if(acc0<=0.1 or acc0>=acc1):
                continue
            acc2=train_2(sym_g, f_log2, times)

            if(0.1<acc0 and acc0<acc1 and acc1<acc2):
                print(f"Good matrix iteration | args.K : {args.K}, args.G : {args.G}, decay : {decay}")

                f_logm.write(f"GOOD Matrix args.K : {args.K}, args.G : {args.G}, decay : {decay}\n")
                f_logm.flush()
                for y1 in range(args.num_label):
                    for y2 in range(args.num_label):
...
# 0426
conda activate vv
python TSBM_Nature6.py --K 0.4 --G 0.8 --epoch 600
python TSBM_Nature6.py --K 0.4 --G 0.6 --epoch 600
python TSBM_Nature6.py --K 0.4 --G 0.4 --epoch 600
python TSBM_Nature6.py --K 0.4 --G 0.3 --epoch 600
python TSBM_Nature6.py --K 0.2 --G 0.8 --epoch 600
python TSBM_Nature6.py --K 0.2 --G 0.6 --epoch 600
python TSBM_Nature6.py --K 0.2 --G 0.4 --epoch 600
python TSBM_Nature6.py --K 0.2 --G 0.3 --epoch 600


python TSBM_Nature6.py --K 0.2 --G 0.4 --decay 0.7 --epoch 600
python TSBM_Nature6.py --K 0.4 --G 0.7 --decay 0.9 --epoch 600
python TSBM_Nature6.py --K 0.8 --G 0.75 --decay 0.85 --epoch 600
python TSBM_Nature6.py --K 0.8 --G 0.8 --decay 0.75 --epoch 600
python TSBM_Nature6.py --K 0.8 --G 0.8 --decay 0.85 --epoch 600
python TSBM_Nature6.py --K 0.5 --G 0.8 --decay 0.85 --epoch 800
