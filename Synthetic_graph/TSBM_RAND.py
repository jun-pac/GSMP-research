...
if __name__ == "__main__":
    ...
    f_log0=open('./txtlog/'+'RA600_'+'b'+str(args.max_beta)+'_'+'g'+str(args.gamma)+'_'+'s'+str(args.feat_std)+'_0','a')
    f_log1=open('./txtlog/'+'RA600_'+'b'+str(args.max_beta)+'_'+'g'+str(args.gamma)+'_'+'s'+str(args.feat_std)+'_1','a')
    f_log2=open('./txtlog/'+'RA600_'+'b'+str(args.max_beta)+'_'+'g'+str(args.gamma)+'_'+'s'+str(args.feat_std)+'_2','a')

    f_log0.write('RA600_'+'b'+str(args.max_beta)+'_'+'g'+str(args.gamma)+'_'+'s'+str(args.feat_std)+'_0\n')
    f_log0.flush()
    f_log1.write('RA600_'+'b'+str(args.max_beta)+'_'+'g'+str(args.gamma)+'_'+'s'+str(args.feat_std)+'_1\n')
    f_log1.flush()
    f_log2.write('RA600_'+'b'+str(args.max_beta)+'_'+'g'+str(args.gamma)+'_'+'s'+str(args.feat_std)+'_2\n')
    f_log2.flush()
...
''' 
# before 0417
python TSBM_RAND.py --gamma 0.16 --max_beta 0.10 --epoch 600
python TSBM_RAND.py --gamma 0.32 --max_beta 0.12 --epoch 600 // 
python TSBM_RAND.py --gamma 0.32 --max_beta 0.16 --epoch 600 // 
python TSBM_RAND.py --gamma 0.4 --max_beta 0.2 --epoch 600 // 
python TSBM_RAND.py --gamma 0.14 --max_beta 0.10 --epoch 600
python TSBM_RAND.py --gamma 0.24 --max_beta 0.12 --epoch 600 //
python TSBM_RAND.py --gamma 0.28 --max_beta 0.16 --epoch 600
python TSBM_RAND.py --gamma 0.3 --max_beta 0.2 --epoch 600

# 0417
python TSBM_RAND.py --gamma 0.12 --max_beta 0.10 --feat_std 2 --epoch 600
python TSBM_RAND.py --gamma 0.20 --max_beta 0.16 --feat_std 2 --epoch 600
python TSBM_RAND.py --gamma 0.24 --max_beta 0.16 --feat_std 2 --epoch 600
python TSBM_RAND.py --gamma 0.32 --max_beta 0.2 --feat_std 2 --epoch 600 //

python TSBM_RAND.py --gamma 0.12 --max_beta 0.10 --feat_std 1 --epoch 600
python TSBM_RAND.py --gamma 0.20 --max_beta 0.16 --feat_std 1 --epoch 600
python TSBM_RAND.py --gamma 0.24 --max_beta 0.16 --feat_std 1 --epoch 600
python TSBM_RAND.py --gamma 0.32 --max_beta 0.2 --feat_std 1 --epoch 600 //
'''
