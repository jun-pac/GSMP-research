...
if __name__ == "__main__":
    ...
    f_log0=open('./txtlog/'+'NC_test_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_0','a')
    f_log1=open('./txtlog/'+'NC_test_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_1','a')
    # f_log2=open('./txtlog/'+'NC_test_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_2','a')
    f_logm=open('./txtlog/'+'NC_matrix_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_0','a')

    f_log0.write('NC_test_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_0\n')
    f_log0.flush()
    f_log1.write('NC_test_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_1\n')
    f_log1.flush()
    # f_log2.write('NC_test_'+'K'+str(args.K)+'_'+'G'+str(args.G)+'_'+'s'+str(args.feat_std)+'_2\n')
    # f_log2.flush()
    ...
    for i in range(args.repeat):
        for num in range(9):
            ...
            for y1 in range(args.num_label):
                ...
                beta=3/2*args.K*num/8
                for y2 in range(0, y1):
                    for t in range(args.num_time):
                        prob[y1][y2][t]=random.uniform(0,args.G*(alpha+beta*(t/args.num_time)))
                        prob[y2][y1][t]=prob[y1][y2][t]
                for t in  range(args.num_time):
                    #prob[y1][y1][t]=random.uniform(0, alpha+beta*(t/args.num_time))
                    prob[y1][y1][t]=random.uniform(0, args.K)
...
conda activate vv
# 0426
python TSBM_Nature3.py --K 0.4 --G 0.4 --epoch 1500
python TSBM_Nature3.py --K 0.4 --G 0.3 --epoch 1500
python TSBM_Nature3.py --K 0.2 --G 0.4 --epoch 1500
python TSBM_Nature3.py --K 0.2 --G 0.3 --epoch 1500
'''